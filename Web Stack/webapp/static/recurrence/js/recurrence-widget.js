...
recurrence.widget.RuleForm.prototype = {
    init: function(panel, mode, rule, options) {
        ...
        this.freq_rules = [
            ...
            new recurrence.Rule(recurrence.MINUTELY, rule_options),
            new recurrence.Rule(recurrence.SECONDLY, rule_options)
        ];
    ...
    init_dom: function() {
        ...
        var forms = [
            ...
            recurrence.widget.RuleMinutelyForm,
            recurrence.widget.RuleSecondlyForm,
...
recurrence.widget.RuleMinutelyForm = function(panel, rule) {
    this.init(panel, rule);
};
recurrence.widget.RuleMinutelyForm.prototype = {
    init: function(panel, rule) {
        this.panel = panel;
        this.rule = rule;
    ...
    init_dom: function() {
        var root = recurrence.widget.e('div', {'class': 'minutely'});
        root.style.display = 'none';
        this.elements = {'root': root};
    },
...
recurrence.widget.RuleSecondlyForm = function(panel, rule) {
    this.init(panel, rule);
};
recurrence.widget.RuleSecondlyForm.prototype = {
    init: function(panel, rule) {
        this.panel = panel;
        this.rule = rule;
    ...
    init_dom: function() {
        var root = recurrence.widget.e('div', {'class': 'secondly'});
        root.style.display = 'none';
        this.elements = {'root': root};
    },
