// ======================================================================
// DataAcquisition.v generated from TopDesign.cysch
// 04/18/2014 at 11:20
...
// ADC_SAR_v2_10(ADC_Clock=1, ADC_Clock_Frequency=10800000, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_Resolution_HW=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=6, Sample_Rate=600000, Sample_Rate_def=631579, CY_COMPONENT_NAME=ADC_SAR_v2_10, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v2_10_0 (
    vplus,
    vminus,
    soc,
    eoc,
	...
	cy_clock_v1_0
		#(.id("d810e983-afb1-4c77-8eb1-c131c7aa6b8c/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d810e983-afb1-4c77-8eb1-c131c7aa6b8c/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
